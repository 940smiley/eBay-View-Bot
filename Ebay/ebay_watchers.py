    ...
    def getSession(self):
        ...
        while True:
            try:
                ...
                print(self.srt2)
                # The following regex and JSON parsing is fragile and should be improved for production use
    ...
    def login(self):
        ...
        while True:
            try:
                ...
                request = self.s.post(data.signIn_URL, headers=data.Headers.login, data=payload, timeout=12, allow_redirects=False)
